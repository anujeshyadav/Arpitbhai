          ...
          <div className="col">
            <Card className="shadow">
              <CardHeader className="border-0">
                <Row>
                  <Col lg="5" md="5" sm="12">
                    <h5 className="mb-0">Landing and User setting Page</h5>
                  </Col>
                  <Col></Col>
                  {/* <Col lg="2" md="2" sm="6">
                    ...
                    <Col lg="2" md="2" sm="6">
                      <Input type="date" placeholder="search here ..." />
                    </Col> */}
                  <Col lg="2" md="2" sm="6">
                    ...
                    <div className="d-flex justify-content-start">
                      ...
                      <div className="parent">
                        <div className="file-upload">
                          <img height="20px" src={uploadImg} alt="upload" />
                          <p>upload</p>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span className="mx-1" style={{ cursor: "pointer" }}>
                        <Edit
                          onClick={() => Navigate("/admin/addcategory/0")}
                          color="blue"
                        />
                      </span>
                    </td>
...
export default Landing_UserPage;
