                  ...
                  <tr>
                    <th scope="row">
                      <Media className="align-items-center">
                        ...
                        <Media>
                          <span className="mb-0 text-sm">xyz</span>
                        </Media>
                      </Media>
                    </th>
                    <td>
                    ...
                    <td>
                      <span style={{ cursor: "pointer" }}>
                        <Eye
                          onClick={() => Navigate("/admin/userDetails/0")}
                          color="green"
                        />
                      </span>
                      ...
                      <span className="mx-1" style={{ cursor: "pointer" }}>
                        <Download
                          title="Points Download history"
                          color="green"
                          onClick={() => {
                            Navigate("/admin/PointHistorypage/0");
                          }}
                        />
                      </span>
                    </td>
